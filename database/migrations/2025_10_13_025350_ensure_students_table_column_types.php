...
return new class extends Migration
{
    ...
    DB::statement("UPDATE students SET created_at = CASE WHEN created_at IS NULL OR created_at::text = '' THEN NOW() ELSE created_at END");
    DB::statement("UPDATE students SET updated_at = CASE WHEN updated_at IS NULL OR updated_at::text = '' THEN NOW() ELSE updated_at END");
